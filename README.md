...
A cab file is also created, `.\tap-windows6\dist\amd64\tap-windows6-amd64.cab`, which must be
submitted to the [Windows Hardware Dev Center](https://developer.microsoft.com/en-us/windows/hardware)
for attestation signing. The attestation-signed driver package must be used for Windows 10 but will
