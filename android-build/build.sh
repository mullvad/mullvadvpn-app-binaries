...
cp libcrypto.a ../android/libcrypto.a
cp libssl.a ../android/libssl.a
cp include/openssl/opensslconf.h ../android/include/openssl/
cp include/openssl/opensslv.h ../android/include/openssl/
popd
